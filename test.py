...
class TestInvertida(unittest.TestCase):
    ...
    def test_invertida_2(self):
        ...
        # neste caso a função estva vazia olhie as de cima de percebi que todao funcção pede:
        # im = pset1.Imagem(y,x,[])
        # resultado = im.funcaoDesejada()
        # im = pset1.Imagem(y,x,[] = desejado)
        # self.assertEqual(resultado,  esperado) --> verifica se ambos são iguais, se o resultado e o esperado são iguais
